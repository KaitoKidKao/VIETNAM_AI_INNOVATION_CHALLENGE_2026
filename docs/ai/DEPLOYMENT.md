...
>
> Decision liên quan: D-005 (`Accepted`, scaffold), D-008 (`Accepted`, web-first), D-006 (`Accepted`, capability/deploy target), D-010 (`Proposed`, CI/release artifact), D-012 (`Accepted`, Cloud Run backend-only) và D-020 (`Accepted`, demo gate client-side)
>
