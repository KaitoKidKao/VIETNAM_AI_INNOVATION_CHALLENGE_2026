...
> Trạng thái: backend production-disabled đã live trên Cloud Run và public smoke pass ngày 2026-07-18. Web app có public host tại `https://vngov.vercel.app`; source production mới chỉ có hiệu lực sau khi CI xanh và merge vào `main`. RAG, LLM, database và procedure data vẫn chưa bật.
>
