...
>
> Decision liên quan: D-005 (`Accepted`, scaffold), D-008 (`Accepted`, web-first), D-006 (`Accepted`, capability/deploy target), D-010 (`Proposed`, CI/release artifact), D-012 (`Accepted`, Cloud Run backend-only) va D-019 (`Accepted`, legacy RAG opt-in/offline demo image)
>
...
D-019 thay image default thanh demo offline (`demo_pack`, RAG/LLM/legacy RAG
