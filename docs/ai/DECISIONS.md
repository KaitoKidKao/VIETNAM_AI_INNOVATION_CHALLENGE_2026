...
| D-018 | Accepted | Deterministic intake guard và conservative typo routing cho ba MVP | `local-20260719-phase6-1-intent-router` | 2026-07-19 |
...
## D-018 — Deterministic intake guard và conservative typo routing
...
- Public endpoint/model không đổi. TrustPolicy, Procedure Pack, checklist, rule engine và ranh giới K1 của D-017 không đổi.
